...
# Creative Technology Systems Lab Course Syllabus

| Course Info
| ---
| Parsons The New School for Design
| School of Art, Media, and Technology
| PUDT 3101 D, CRN 3637 
| Fall 2018
...
### Learning Outcomes
Creative Technologies Systems is taught in two classes: a Studio that focuses on context, communication and critique, and a Lab that focuses on methodology, technology, and making. The primary learning objectives for each pillar are outlined below.

#### Key Lab Learning Outcomes

**Methodology: Process-Oriented Design**

Learning Objective: Introduce and practice key design processes including primary and secondary research, sketching, design studies, prototyping, user-testing, and iteration.

Assessable Outcome: Employ these key design processes in a series of assignments and projects.

**Technology: Data APIs**

Learning Objective: Conceive and implement projects that incorporate networked data-sources. 

Assessable Outcome: Recognize the affordances, possibilities, and constraints of APIs. 

**Making: Web Portfolio**

Learning Objective: Bolster web-based coding skills and communication strategies in order to create an online portfolio that communicates a cohesive idea trajectory or set of projects.

Assessable Outcome: Create a compelling web-based portfolio that presents a set of DT projects for a specific audience.

#### Key Studio Learning Outcomes

**Context: Audience-Awareness**

Learning Objective: Build understanding about how designs meet the needs, values, and goals of specific audiences. 

Assessable Outcome: Students will conduct iterative user-testing and user needs assessments. 

**Communication: Impact**

Learning Objective: Introduce tools to assess user needs and design propositions such as qualitative and quantitative research, ethnographic/demographic/participatory research, user surveys, user interviews, and user testing. 

Assessable Outcome: Identify and use the right assessment tools to better understand the impact and effectiveness of their projects. 

**Critique: Presentations**

Learning Objective: Practice and hone verbal presentation methods to communicate design intentions,processes, and outcomes. 

Assessable Outcome: Demonstrate ability to clearly convey their design intentions, processes, and outcomes in the context of project presentations.  

### Primary Assignments

#### 5 in 5
Define a set of rules or constraints that will guide a series of small projects. Execute a creative project every day for five days based on these constraints.

#### Ideas in Form
Research a specific subject of interest. Create a series of projects exploring your subject in different media.

#### Instruction Sets for Strangers
Analyze: Choose a space you find interesting. Research its history & architecture. Observe its flows & patterns for 24 hours. Document & map your findings.

Define: Design a site-specific intervention you think would facilitate meaningful interaction. Research & define it. Consider the ideas of invitation (how to get people involved) and triangulation (how to get people to interact with one another).

Test: Deploy your prototype in  the space. Observe and document the results.

#### Final Project
Students work individually to formulate a creative premise or question, use design to investigate their premise and ultimately arrive at a project based response. Students are encouraged to think about their own personal design process: what ideas interest them, how they research them, how they develop a personal premise (opinion) about them, and how they produce a creative work in response to their query.


#### Personal Site
Students will post course work—including reading responses, writing assignments, project prototypes, work in progress, and final documentation—to their own website. This site will initially be built using hand-made HTML, CSS, and Javascript and hosted using Github pages.
Students who demonstrate an solid understanding of these technologies may switch to other technologies with instructor approval. At the end of the semester, students must complete a web-based portfolio.
...
The focus of this class is on design process not final results. Most of your grade will reflect your ability to apply process-oriented design to an domain of inquiry and clearly communicate your process and findings.

### Grading Considerations
 
#### Communication
How well is the student able to express their ideas, both verbally and with other forms of communication such as: writing, drawing, mapping, and documenting?

#### Critical Thinking and Reflective Judgment
To what degree has the student demonstrated and developed critical thinking skills over the course of the semester? How well can the student apply these skills to producing and evaluating Design and Technology projects supported with research and evidence? 

#### Design Process
How well does the student incorporate process-oriented design methods including sketching, brainstorming, researching, prototyping, user testing, and iteration. Can the student effectively develop and validate solutions to design problems.
...
| 7 in 7 | 10%
| Ideas in Form | 20%
| Instruction Sets for Strangers | 20%
| Final Project | 20%
| Studio Participation | 30%



### Resubmitting and Making Up Work

Because this class emphasizes process-oriented design and includes group assignments, I strongly discourage resubmitted or make-up assignments. Please make every effort to complete your assignments each week. If you anticipate difficulty for any reason, please speak with me immediately to make a plan.
...
As this is a project based course, you may need to purchase various materials and supplies required to support your individual projects. 

### Office Hours
By appointment. Email to arrange. I will typically be available before and after class for quick questions and informal discussion.


### Backups and Github
Each student **must** keep backups of their digital work, including source code and images and be prepared to **submit or re-submit** this work at anytime. I strongly suggest that you host your work on Github to benefit from both versioning and backup. Data loss, regardless of fault—yours, mine, or a third party—will not be accepted as an excuse for missing work.


### Attendance
In short: **Attend every class, get there early, stay late.**

This class meets twice a week and the pace will be fast. New material will be introduced each week and in-class workshops and discussions will be held in nearly every class. Missing even a single class will impact your participation in the class and you will be responsible for making up for that impact.

**If you miss three or more classes your final grade will most likely be reduced.**
**If you miss six or more classes you will most likely be asked to withdraw from the class.**

This includes absences from the first class due to late enrollment. Late arrivals or early departures may count as an absence. Inappropriate use of a laptop (e.g. browsing social media during critiques or lectures) may result in being marked as absent and will certainly impact your participation grade.
...
### Laptops + Devices
We will spend a good amount of class time working together on projects. During work time, computers will sometimes be used. However, during lectures, discussion, and critiques computers must be closed. Note-taking can be done on paper. Nothing kills a conversation like a room full of people staring at screens.
